...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/widget/bg;->a:Ljava/util/ArrayList;
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    invoke-virtual {p0}, Landroid/support/v7/widget/bg;->getResources()Landroid/content/res/Resources;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/bg;->c:Landroid/content/res/Resources$Theme;

    iget-object v0, p0, Landroid/support/v7/widget/bg;->c:Landroid/content/res/Resources$Theme;
...
.method public static a(Landroid/content/Context;)Landroid/content/Context;
    ...
    sget-object v1, Landroid/support/v7/widget/bg;->a:Ljava/util/ArrayList;
    ...
    sget-object v0, Landroid/support/v7/widget/bg;->a:Ljava/util/ArrayList;
...
.method private static b(Landroid/content/Context;)Z
    ...
    :cond_1
    invoke-static {}, Landroid/support/v7/a/h;->k()Z
...
.method public getResources()Landroid/content/res/Resources;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/bg;->b:Landroid/content/res/Resources;
    ...
    :goto_0
    iput-object v0, p0, Landroid/support/v7/widget/bg;->b:Landroid/content/res/Resources;
