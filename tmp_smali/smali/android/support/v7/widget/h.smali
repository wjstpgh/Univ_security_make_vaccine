...
.method private b(Landroid/graphics/drawable/Drawable;)Z
    ...
    iget-object v1, p0, Landroid/support/v7/widget/h;->e:Landroid/support/v7/widget/bh;

    if-nez v1, :cond_0

    new-instance v1, Landroid/support/v7/widget/bh;

    invoke-direct {v1}, Landroid/support/v7/widget/bh;-><init>()V

    iput-object v1, p0, Landroid/support/v7/widget/h;->e:Landroid/support/v7/widget/bh;
    ...
    invoke-static {v2}, Landroid/support/v4/view/ah;->w(Landroid/view/View;)Landroid/content/res/ColorStateList;
    ...
    iput-object v2, v1, Landroid/support/v7/widget/bh;->a:Landroid/content/res/ColorStateList;

    :cond_1
    iget-object v2, p0, Landroid/support/v7/widget/h;->a:Landroid/view/View;

    invoke-static {v2}, Landroid/support/v4/view/ah;->x(Landroid/view/View;)Landroid/graphics/PorterDuff$Mode;

    move-result-object v2

    if-eqz v2, :cond_2

    iput-boolean v0, v1, Landroid/support/v7/widget/bh;->c:Z

    iput-object v2, v1, Landroid/support/v7/widget/bh;->b:Landroid/graphics/PorterDuff$Mode;
    ...
    iget-boolean v2, v1, Landroid/support/v7/widget/bh;->c:Z
    ...
    invoke-static {p1, v1, v2}, Landroid/support/v7/widget/m;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/bh;[I)V
...
.method a()Landroid/content/res/ColorStateList;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/h;->d:Landroid/support/v7/widget/bh;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/h;->d:Landroid/support/v7/widget/bh;

    iget-object v0, v0, Landroid/support/v7/widget/bh;->a:Landroid/content/res/ColorStateList;
...
.method a(Landroid/content/res/ColorStateList;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/h;->d:Landroid/support/v7/widget/bh;

    :cond_0
    iget-object v0, p0, Landroid/support/v7/widget/h;->d:Landroid/support/v7/widget/bh;

    iput-object p1, v0, Landroid/support/v7/widget/bh;->a:Landroid/content/res/ColorStateList;

    iget-object v0, p0, Landroid/support/v7/widget/h;->d:Landroid/support/v7/widget/bh;

    const/4 v1, 0x1

    iput-boolean v1, v0, Landroid/support/v7/widget/bh;->d:Z
...
.method a(Landroid/graphics/PorterDuff$Mode;)V
    ...
    iput-object p1, v0, Landroid/support/v7/widget/bh;->b:Landroid/graphics/PorterDuff$Mode;

    iget-object v0, p0, Landroid/support/v7/widget/h;->d:Landroid/support/v7/widget/bh;

    const/4 v1, 0x1

    iput-boolean v1, v0, Landroid/support/v7/widget/bh;->c:Z
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    invoke-static {v2, v3}, Landroid/support/v7/widget/an;->a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
...
.method b()Landroid/graphics/PorterDuff$Mode;
    ...
    iget-object v0, v0, Landroid/support/v7/widget/bh;->b:Landroid/graphics/PorterDuff$Mode;
...
.method b(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/h;->c:Landroid/support/v7/widget/bh;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/h;->c:Landroid/support/v7/widget/bh;
...
.method c()V
    ...
    :cond_1
    iget-object v1, p0, Landroid/support/v7/widget/h;->d:Landroid/support/v7/widget/bh;
    ...
    invoke-static {v0, v1, v2}, Landroid/support/v7/widget/m;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/bh;[I)V

    goto :goto_0

    :cond_2
    iget-object v1, p0, Landroid/support/v7/widget/h;->c:Landroid/support/v7/widget/bh;
