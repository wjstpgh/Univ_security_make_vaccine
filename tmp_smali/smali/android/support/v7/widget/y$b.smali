...
.method public constructor <init>(Landroid/support/v7/widget/y;Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/y$b;->e:Landroid/graphics/Rect;

    invoke-virtual {p0, p1}, Landroid/support/v7/widget/y$b;->a(Landroid/view/View;)V
...
.method static synthetic a(Landroid/support/v7/widget/y$b;)Landroid/widget/ListAdapter;
    .locals 1

    iget-object v0, p0, Landroid/support/v7/widget/y$b;->d:Landroid/widget/ListAdapter;

    return-object v0
.end method

.method static synthetic a(Landroid/support/v7/widget/y$b;Landroid/view/View;)Z
    .locals 1

    invoke-direct {p0, p1}, Landroid/support/v7/widget/y$b;->b(Landroid/view/View;)Z
...
.method static synthetic b(Landroid/support/v7/widget/y$b;)V
    .locals 0

    invoke-super {p0}, Landroid/support/v7/widget/aq;->c()V
...
.method private b(Landroid/view/View;)Z
    ...
    iget-object v0, p0, Landroid/support/v7/widget/y$b;->e:Landroid/graphics/Rect;
...
.method public a()Ljava/lang/CharSequence;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/y$b;->c:Ljava/lang/CharSequence;
...
.method public a(Landroid/widget/ListAdapter;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/y$b;->d:Landroid/widget/ListAdapter;
...
.method public a(Ljava/lang/CharSequence;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/y$b;->c:Ljava/lang/CharSequence;
...
.method b()V
    ...
    invoke-virtual {p0}, Landroid/support/v7/widget/y$b;->d()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/y$b;->a:Landroid/support/v7/widget/y;
    ...
    invoke-static {v2, v0, v6}, Landroid/support/v7/widget/y;->a(Landroid/support/v7/widget/y;Landroid/widget/SpinnerAdapter;Landroid/graphics/drawable/Drawable;)I
    ...
    iget-object v6, p0, Landroid/support/v7/widget/y$b;->a:Landroid/support/v7/widget/y;
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/y$b;->f(I)V
    ...
    invoke-virtual {p0}, Landroid/support/v7/widget/y$b;->h()I
    ...
    :cond_1
    iget-object v1, p0, Landroid/support/v7/widget/y$b;->a:Landroid/support/v7/widget/y;
...
.method public c()V
    ...
    invoke-virtual {p0}, Landroid/support/v7/widget/y$b;->k()Z
    ...
    invoke-virtual {p0, v1}, Landroid/support/v7/widget/y$b;->g(I)V

    invoke-super {p0}, Landroid/support/v7/widget/aq;->c()V

    invoke-virtual {p0}, Landroid/support/v7/widget/y$b;->m()Landroid/widget/ListView;
