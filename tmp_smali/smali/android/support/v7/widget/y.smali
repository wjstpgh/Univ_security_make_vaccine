...
.field private g:Landroid/support/v7/widget/aq$b;

.field private h:Landroid/widget/SpinnerAdapter;

.field private i:Z

.field private j:Landroid/support/v7/widget/y$b;
...
.method static constructor <clinit>()V
    ...
    :goto_0
    sput-boolean v0, Landroid/support/v7/widget/y;->a:Z
    ...
    :goto_1
    sput-boolean v0, Landroid/support/v7/widget/y;->b:Z
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;IILandroid/content/res/Resources$Theme;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/y;->l:Landroid/graphics/Rect;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/y;->d:Landroid/support/v7/widget/m;

    new-instance v0, Landroid/support/v7/widget/h;

    iget-object v2, p0, Landroid/support/v7/widget/y;->d:Landroid/support/v7/widget/m;

    invoke-direct {v0, p0, v2}, Landroid/support/v7/widget/h;-><init>(Landroid/view/View;Landroid/support/v7/widget/m;)V
    ...
    iput v5, p0, Landroid/support/v7/widget/y;->k:I
    ...
    iput-object v0, p0, Landroid/support/v7/widget/y;->j:Landroid/support/v7/widget/y$b;
    ...
    iput-object v2, p0, Landroid/support/v7/widget/y;->g:Landroid/support/v7/widget/aq$b;

    :cond_2
    sget v0, Landroid/support/v7/b/a$k;->Spinner_android_entries:I

    invoke-virtual {v4, v0}, Landroid/support/v7/widget/bj;->e(I)[Ljava/lang/CharSequence;
...
.method static synthetic a(Landroid/support/v7/widget/y;Landroid/widget/SpinnerAdapter;Landroid/graphics/drawable/Drawable;)I
    .locals 1

    invoke-direct {p0, p1, p2}, Landroid/support/v7/widget/y;->a(Landroid/widget/SpinnerAdapter;Landroid/graphics/drawable/Drawable;)I
...
.method private a(Landroid/widget/SpinnerAdapter;Landroid/graphics/drawable/Drawable;)I
    ...
    iget-object v0, p0, Landroid/support/v7/widget/y;->l:Landroid/graphics/Rect;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/y;->l:Landroid/graphics/Rect;
...
.method static synthetic a(Landroid/support/v7/widget/y;)Landroid/support/v7/widget/y$b;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/y;->j:Landroid/support/v7/widget/y$b;
...
.method public getDropDownHorizontalOffset()I
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/y$b;->f()I
    ...
    :cond_0
    sget-boolean v0, Landroid/support/v7/widget/y;->b:Z
...
.method public getPopupBackground()Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/y$b;->d()Landroid/graphics/drawable/Drawable;
...
.method protected onMeasure(II)V
    ...
    invoke-direct {p0, v1, v2}, Landroid/support/v7/widget/y;->a(Landroid/widget/SpinnerAdapter;Landroid/graphics/drawable/Drawable;)I
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Landroid/support/v7/widget/y;->g:Landroid/support/v7/widget/aq$b;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/y;->g:Landroid/support/v7/widget/aq$b;

    invoke-virtual {v0, p0, p1}, Landroid/support/v7/widget/aq$b;->onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z
...
.method public setAdapter(Landroid/widget/SpinnerAdapter;)V
    ...
    :goto_1
    iget-object v1, p0, Landroid/support/v7/widget/y;->j:Landroid/support/v7/widget/y$b;
...
.method public setDropDownWidth(I)V
    ...
    iput p1, p0, Landroid/support/v7/widget/y;->k:I
