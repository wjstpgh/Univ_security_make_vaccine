...
.field private d:Landroid/support/v7/widget/bb$b;
...
.method static synthetic a(Landroid/support/v7/widget/bb;)Landroid/support/v7/widget/LinearLayoutCompat;
    .locals 1

    iget-object v0, p0, Landroid/support/v7/widget/bb;->e:Landroid/support/v7/widget/LinearLayoutCompat;

    return-object v0
.end method

.method private a(Landroid/support/v7/a/a$c;Z)Landroid/support/v7/widget/bb$c;
    .locals 4
    ...
    invoke-virtual {v0, v2}, Landroid/support/v7/widget/bb$c;->setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/bb;->d:Landroid/support/v7/widget/bb$b;

    if-nez v1, :cond_1

    new-instance v1, Landroid/support/v7/widget/bb$b;

    invoke-direct {v1, p0, v2}, Landroid/support/v7/widget/bb$b;-><init>(Landroid/support/v7/widget/bb;Landroid/support/v7/widget/bb$1;)V

    iput-object v1, p0, Landroid/support/v7/widget/bb;->d:Landroid/support/v7/widget/bb$b;
...
.method static synthetic a(Landroid/support/v7/widget/bb;Landroid/support/v7/a/a$c;Z)Landroid/support/v7/widget/bb$c;
    .locals 1

    invoke-direct {p0, p1, p2}, Landroid/support/v7/widget/bb;->a(Landroid/support/v7/a/a$c;Z)Landroid/support/v7/widget/bb$c;
...
.method private b()V
    ...
    invoke-direct {v1, p0, v4}, Landroid/support/v7/widget/bb$a;-><init>(Landroid/support/v7/widget/bb;Landroid/support/v7/widget/bb$1;)V
    ...
    iput-object v4, p0, Landroid/support/v7/widget/bb;->a:Ljava/lang/Runnable;
...
.method public onMeasure(II)V
    ...
    iget-object v4, p0, Landroid/support/v7/widget/bb;->e:Landroid/support/v7/widget/LinearLayoutCompat;
    ...
    iput v3, p0, Landroid/support/v7/widget/bb;->b:I

    :goto_1
    iget v3, p0, Landroid/support/v7/widget/bb;->b:I

    iget v4, p0, Landroid/support/v7/widget/bb;->c:I
    ...
    iget-object v1, p0, Landroid/support/v7/widget/bb;->e:Landroid/support/v7/widget/LinearLayoutCompat;
