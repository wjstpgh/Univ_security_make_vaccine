...
.field private r:Landroid/support/v7/widget/aj;
...
.method constructor <init>(Landroid/content/Context;Landroid/view/Window;Landroid/support/v7/a/g;)V
    ...
    invoke-direct {p0, p1, p2, p3}, Landroid/support/v7/a/i;-><init>(Landroid/content/Context;Landroid/view/Window;Landroid/support/v7/a/g;)V

    const/4 v0, 0x0

    iput-object v0, p0, Landroid/support/v7/a/m;->q:Landroid/support/v4/view/az;
...
.method private a(IZ)Landroid/support/v7/a/m$d;
    .locals 4
...
.method private a(Landroid/view/Menu;)Landroid/support/v7/a/m$d;
    ...
    iget-object v4, v1, Landroid/support/v7/a/m$d;->j:Landroid/support/v7/view/menu/f;
...
.method private a(ILandroid/support/v7/a/m$d;Landroid/view/Menu;)V
    ...
    iget-object p3, p2, Landroid/support/v7/a/m$d;->j:Landroid/support/v7/view/menu/f;
    ...
    :cond_3
    invoke-virtual {p0}, Landroid/support/v7/a/m;->p()Z
...
.method private a(Landroid/support/v7/a/m$d;Landroid/view/KeyEvent;)V
    ...
    :cond_2
    invoke-virtual {p0}, Landroid/support/v7/a/m;->q()Landroid/view/Window$Callback;
    ...
    iget-object v5, p1, Landroid/support/v7/a/m$d;->j:Landroid/support/v7/view/menu/f;
...
.method private a(Landroid/support/v7/a/m$d;Z)V
    ...
    iget-object v0, p0, Landroid/support/v7/a/m;->r:Landroid/support/v7/widget/aj;
    ...
    iget-object v0, p1, Landroid/support/v7/a/m$d;->j:Landroid/support/v7/view/menu/f;

    invoke-direct {p0, v0}, Landroid/support/v7/a/m;->b(Landroid/support/v7/view/menu/f;)V
...
.method static synthetic a(Landroid/support/v7/a/m;Landroid/support/v7/view/menu/f;)V
    .locals 0

    invoke-direct {p0, p1}, Landroid/support/v7/a/m;->b(Landroid/support/v7/view/menu/f;)V
...
.method private a(Landroid/support/v7/view/menu/f;Z)V
    ...
    iget-object v1, p0, Landroid/support/v7/a/m;->r:Landroid/support/v7/widget/aj;

    invoke-interface {v1}, Landroid/support/v7/widget/aj;->e()Z
    ...
    :cond_2
    invoke-direct {p0, v4, v3}, Landroid/support/v7/a/m;->a(IZ)Landroid/support/v7/a/m$d;

    move-result-object v1

    iget-object v2, v1, Landroid/support/v7/a/m$d;->j:Landroid/support/v7/view/menu/f;
    ...
    iget-object v3, v1, Landroid/support/v7/a/m$d;->j:Landroid/support/v7/view/menu/f;
    ...
    iget-object v1, v1, Landroid/support/v7/a/m$d;->j:Landroid/support/v7/view/menu/f;

    invoke-interface {v0, v5, v1}, Landroid/view/Window$Callback;->onMenuOpened(ILandroid/view/Menu;)Z

    iget-object v0, p0, Landroid/support/v7/a/m;->r:Landroid/support/v7/widget/aj;

    invoke-interface {v0}, Landroid/support/v7/widget/aj;->g()Z
    ...
    invoke-interface {v1}, Landroid/support/v7/widget/aj;->h()Z
...
.method private a(Landroid/support/v7/a/m$d;)Z
    ...
    invoke-virtual {p0}, Landroid/support/v7/a/m;->n()Landroid/content/Context;
...
.method private a(Landroid/support/v7/a/m$d;ILandroid/view/KeyEvent;I)Z
    ...
    :cond_2
    iget-object v1, p1, Landroid/support/v7/a/m$d;->j:Landroid/support/v7/view/menu/f;
...
.method private b(Landroid/support/v7/view/menu/f;)V
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/aj;->j()V
...
.method private b(Landroid/support/v7/a/m$d;)Z
    ...
    invoke-virtual {p1, v1}, Landroid/support/v7/a/m$d;->a(Landroid/support/v7/view/menu/f;)V
...
.method private b(Landroid/support/v7/a/m$d;Landroid/view/KeyEvent;)Z
    ...
    iget-object v4, p0, Landroid/support/v7/a/m;->r:Landroid/support/v7/widget/aj;

    if-eqz v4, :cond_6

    iget-object v4, p0, Landroid/support/v7/a/m;->r:Landroid/support/v7/widget/aj;

    invoke-interface {v4}, Landroid/support/v7/widget/aj;->i()V
    ...
    invoke-virtual {p0}, Landroid/support/v7/a/m;->m()Landroid/support/v7/a/a;
    ...
    :cond_7
    iget-object v4, p1, Landroid/support/v7/a/m$d;->j:Landroid/support/v7/view/menu/f;
    ...
    invoke-interface {v4, v5, v6}, Landroid/support/v7/widget/aj;->a(Landroid/view/Menu;Landroid/support/v7/view/menu/l$a;)V
    ...
    invoke-virtual {p1, v7}, Landroid/support/v7/a/m$d;->a(Landroid/support/v7/view/menu/f;)V
    ...
    invoke-interface {v0, v7, v1}, Landroid/support/v7/widget/aj;->a(Landroid/view/Menu;Landroid/support/v7/view/menu/l$a;)V
...
.method private c(Landroid/support/v7/a/m$d;)Z
    ...
    invoke-virtual {p1, v0}, Landroid/support/v7/a/m$d;->a(Landroid/support/v7/view/menu/l$a;)Landroid/support/v7/view/menu/m;
...
.method private d(I)V
    ...
    invoke-direct {p0, p1, v1}, Landroid/support/v7/a/m;->a(IZ)Landroid/support/v7/a/m$d;
...
.method private d(ILandroid/view/KeyEvent;)Z
    ...
    invoke-direct {p0, p1, v0}, Landroid/support/v7/a/m;->a(IZ)Landroid/support/v7/a/m$d;
...
.method private e(ILandroid/view/KeyEvent;)Z
    ...
    :cond_0
    invoke-direct {p0, p1, v2}, Landroid/support/v7/a/m;->a(IZ)Landroid/support/v7/a/m$d;
...
.method private f(I)V
    ...
    invoke-direct {p0, p1, v4}, Landroid/support/v7/a/m;->a(IZ)Landroid/support/v7/a/m$d;

    move-result-object v0

    iget-object v1, v0, Landroid/support/v7/a/m$d;->j:Landroid/support/v7/view/menu/f;
    ...
    iget-object v2, v0, Landroid/support/v7/a/m$d;->j:Landroid/support/v7/view/menu/f;
    ...
    invoke-direct {p0, v3, v3}, Landroid/support/v7/a/m;->a(IZ)Landroid/support/v7/a/m$d;
...
.method private t()V
    ...
    invoke-virtual {p0}, Landroid/support/v7/a/m;->r()Ljava/lang/CharSequence;
    ...
    invoke-direct {p0, v2, v2}, Landroid/support/v7/a/m;->a(IZ)Landroid/support/v7/a/m$d;
    ...
    iget-object v0, v0, Landroid/support/v7/a/m$d;->j:Landroid/support/v7/view/menu/f;
...
.method private u()Landroid/view/ViewGroup;
    ...
    iput-object v1, p0, Landroid/support/v7/a/m;->r:Landroid/support/v7/widget/aj;
    ...
    invoke-interface {v1, v6}, Landroid/support/v7/widget/aj;->a(I)V
...
.method private w()V
    ...
    iget-object v0, p0, Landroid/support/v7/a/m;->q:Landroid/support/v4/view/az;
...
.method public a(Landroid/support/v7/view/b$a;)Landroid/support/v7/view/b;
    ...
    iget-object v1, p0, Landroid/support/v7/a/m;->e:Landroid/support/v7/a/g;
    ...
    invoke-interface {v1, v2}, Landroid/support/v7/a/g;->a(Landroid/support/v7/view/b;)V
...
.method public a(Landroid/content/res/Configuration;)V
    ...
    :cond_0
    invoke-virtual {p0}, Landroid/support/v7/a/m;->i()Z
...
.method public a(Landroid/os/Bundle;)V
    ...
    invoke-static {v0}, Landroid/support/v4/b/ab;->c(Landroid/app/Activity;)Ljava/lang/String;
...
.method public a(Landroid/support/v7/view/menu/f;)V
    ...
    invoke-direct {p0, p1, v0}, Landroid/support/v7/a/m;->a(Landroid/support/v7/view/menu/f;Z)V
...
.method public a(Landroid/support/v7/widget/Toolbar;)V
    ...
    :goto_1
    invoke-virtual {p0}, Landroid/support/v7/a/m;->e()V
...
.method a(ILandroid/view/KeyEvent;)Z
    ...
    invoke-direct {p0, v1, v0}, Landroid/support/v7/a/m;->a(IZ)Landroid/support/v7/a/m$d;
...
.method b(Landroid/support/v7/view/b$a;)Landroid/support/v7/view/b;
    ...
    :cond_0
    new-instance v4, Landroid/support/v7/a/m$b;

    invoke-direct {v4, p0, p1}, Landroid/support/v7/a/m$b;-><init>(Landroid/support/v7/a/m;Landroid/support/v7/view/b$a;)V

    iget-object v0, p0, Landroid/support/v7/a/m;->e:Landroid/support/v7/a/g;
    ...
    invoke-interface {v0, v4}, Landroid/support/v7/a/g;->a(Landroid/support/v7/view/b$a;)Landroid/support/v7/view/b;
    :try_end_0
    ...
    invoke-interface {v0, v1}, Landroid/support/v7/a/g;->a(Landroid/support/v7/view/b;)V
    ...
    iget-object v7, p0, Landroid/support/v7/a/m;->a:Landroid/content/Context;
    ...
    iput-object v6, p0, Landroid/support/v7/a/m;->n:Landroid/support/v7/widget/ActionBarContextView;
    ...
    iput-object v6, p0, Landroid/support/v7/a/m;->o:Landroid/widget/PopupWindow;

    iget-object v6, p0, Landroid/support/v7/a/m;->o:Landroid/widget/PopupWindow;
    ...
    iget-object v7, p0, Landroid/support/v7/a/m;->n:Landroid/support/v7/widget/ActionBarContextView;
    ...
    iget-object v5, p0, Landroid/support/v7/a/m;->n:Landroid/support/v7/widget/ActionBarContextView;
    ...
    iput-object v5, p0, Landroid/support/v7/a/m;->m:Landroid/support/v7/view/b;
...
.method b(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/a/a;->c(Ljava/lang/CharSequence;)V
...
.method b(ILandroid/view/KeyEvent;)Z
    ...
    invoke-direct {p0, v1, v1}, Landroid/support/v7/a/m;->a(IZ)Landroid/support/v7/a/m$d;
...
.method public f()V
    ...
    invoke-super {p0}, Landroid/support/v7/a/i;->f()V
