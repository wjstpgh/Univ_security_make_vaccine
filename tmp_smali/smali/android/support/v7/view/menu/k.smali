...
.method public c()Landroid/support/v7/widget/aq;
    .locals 1

    iget-object v0, p0, Landroid/support/v7/view/menu/k;->l:Landroid/support/v7/widget/aq;
...
.method public d()Z
    ...
    invoke-direct {v2, v3, v4, v5, v6}, Landroid/support/v7/widget/aq;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V

    iput-object v2, p0, Landroid/support/v7/view/menu/k;->l:Landroid/support/v7/widget/aq;

    iget-object v2, p0, Landroid/support/v7/view/menu/k;->l:Landroid/support/v7/widget/aq;

    invoke-virtual {v2, p0}, Landroid/support/v7/widget/aq;->a(Landroid/widget/PopupWindow$OnDismissListener;)V

    iget-object v2, p0, Landroid/support/v7/view/menu/k;->l:Landroid/support/v7/widget/aq;

    invoke-virtual {v2, p0}, Landroid/support/v7/widget/aq;->a(Landroid/widget/AdapterView$OnItemClickListener;)V

    iget-object v2, p0, Landroid/support/v7/view/menu/k;->l:Landroid/support/v7/widget/aq;

    iget-object v3, p0, Landroid/support/v7/view/menu/k;->f:Landroid/support/v7/view/menu/k$a;

    invoke-virtual {v2, v3}, Landroid/support/v7/widget/aq;->a(Landroid/widget/ListAdapter;)V

    iget-object v2, p0, Landroid/support/v7/view/menu/k;->l:Landroid/support/v7/widget/aq;

    invoke-virtual {v2, v1}, Landroid/support/v7/widget/aq;->a(Z)V
    ...
    invoke-virtual {v0, v2}, Landroid/support/v7/widget/aq;->a(Landroid/view/View;)V

    iget-object v0, p0, Landroid/support/v7/view/menu/k;->l:Landroid/support/v7/widget/aq;

    iget v2, p0, Landroid/support/v7/view/menu/k;->r:I

    invoke-virtual {v0, v2}, Landroid/support/v7/widget/aq;->d(I)V
    ...
    invoke-virtual {v0, v2}, Landroid/support/v7/widget/aq;->f(I)V

    iget-object v0, p0, Landroid/support/v7/view/menu/k;->l:Landroid/support/v7/widget/aq;

    const/4 v2, 0x2

    invoke-virtual {v0, v2}, Landroid/support/v7/widget/aq;->g(I)V
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/aq;->m()Landroid/widget/ListView;
...
.method public onDismiss()V
    ...
    iput-object v1, p0, Landroid/support/v7/view/menu/k;->l:Landroid/support/v7/widget/aq;
