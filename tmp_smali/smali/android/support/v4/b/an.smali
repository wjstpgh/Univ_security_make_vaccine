.class Landroid/support/v4/b/an;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/b/an;->a:Ljava/lang/Object;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Landroid/support/v4/b/an;->d:Ljava/lang/Object;

    return-void
.end method

.method public static a(Landroid/app/Notification$Builder;Landroid/support/v4/b/aj$a;)Landroid/os/Bundle;
    .locals 3
...
.method public static a(Landroid/app/Notification;)Landroid/os/Bundle;
    ...
    sget-object v2, Landroid/support/v4/b/an;->a:Ljava/lang/Object;

    monitor-enter v2

    :try_start_0
    sget-boolean v0, Landroid/support/v4/b/an;->c:Z
    ...
    :cond_0
    :try_start_1
    sget-object v0, Landroid/support/v4/b/an;->b:Ljava/lang/reflect/Field;
    ...
    sput-boolean v0, Landroid/support/v4/b/an;->c:Z
    :try_end_1
    ...
    sput-object v0, Landroid/support/v4/b/an;->b:Ljava/lang/reflect/Field;
    ...
    sget-object v3, Landroid/support/v4/b/an;->b:Ljava/lang/reflect/Field;
...
.method private static a(Landroid/support/v4/b/aj$a;)Landroid/os/Bundle;
    .locals 3
...
.method public static a([Landroid/support/v4/b/aj$a;)Ljava/util/ArrayList;
    ...
    invoke-static {v3}, Landroid/support/v4/b/an;->a(Landroid/support/v4/b/aj$a;)Landroid/os/Bundle;
...
.method public static a(Landroid/support/v4/b/af;Ljava/lang/CharSequence;ZLjava/lang/CharSequence;Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;Z)V
    .locals 2

    new-instance v0, Landroid/app/Notification$BigPictureStyle;

    invoke-interface {p0}, Landroid/support/v4/b/af;->a()Landroid/app/Notification$Builder;
...
.method public static a(Landroid/support/v4/b/af;Ljava/lang/CharSequence;ZLjava/lang/CharSequence;Ljava/lang/CharSequence;)V
    .locals 2
...
.method public static a(Landroid/support/v4/b/af;Ljava/lang/CharSequence;ZLjava/lang/CharSequence;Ljava/util/ArrayList;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
