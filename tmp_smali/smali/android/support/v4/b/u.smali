...
.field k:Landroid/support/v4/b/l;
...
.method public constructor <init>(Landroid/support/v4/b/l;)V
    ...
    iget-object v0, p1, Landroid/support/v4/b/l;->H:Ljava/lang/String;
    ...
    iget-object v0, p1, Landroid/support/v4/b/l;->r:Landroid/os/Bundle;
...
# virtual methods
.method public a(Landroid/support/v4/b/p;Landroid/support/v4/b/l;)Landroid/support/v4/b/l;
    .locals 3

    iget-object v0, p0, Landroid/support/v4/b/u;->k:Landroid/support/v4/b/l;
    ...
    iput-object v1, p0, Landroid/support/v4/b/u;->k:Landroid/support/v4/b/l;
    ...
    iput-object v1, v0, Landroid/support/v4/b/l;->n:Landroid/os/Bundle;
    ...
    iput-boolean v1, v0, Landroid/support/v4/b/l;->z:Z
    ...
    iput v1, v0, Landroid/support/v4/b/l;->G:I

    iget-object v0, p0, Landroid/support/v4/b/u;->k:Landroid/support/v4/b/l;

    iget-object v1, p0, Landroid/support/v4/b/u;->f:Ljava/lang/String;

    iput-object v1, v0, Landroid/support/v4/b/l;->H:Ljava/lang/String;

    iget-object v0, p0, Landroid/support/v4/b/u;->k:Landroid/support/v4/b/l;

    iget-boolean v1, p0, Landroid/support/v4/b/u;->g:Z

    iput-boolean v1, v0, Landroid/support/v4/b/l;->K:Z
    ...
    iput-object v1, v0, Landroid/support/v4/b/l;->B:Landroid/support/v4/b/r;
    ...
    iget-object v2, p0, Landroid/support/v4/b/u;->k:Landroid/support/v4/b/l;
