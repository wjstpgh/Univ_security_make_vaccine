...
.method constructor <init>(Landroid/support/v4/widget/h;)V
    ...
    iput-object v0, p0, Landroid/support/v4/widget/h$a;->c:Landroid/graphics/Rect;
...
.method private a(Landroid/support/v4/view/a/c;Landroid/support/v4/view/a/c;)V
    ...
    iget-object v0, p0, Landroid/support/v4/widget/h$a;->c:Landroid/graphics/Rect;
...
.method private a(Landroid/support/v4/view/a/c;Landroid/view/ViewGroup;)V
    ...
    invoke-static {v2}, Landroid/support/v4/widget/h;->l(Landroid/view/View;)Z
...
.method public a(Landroid/view/View;Landroid/support/v4/view/a/c;)V
    ...
    invoke-static {}, Landroid/support/v4/widget/h;->e()Z
    ...
    :goto_0
    const-class v0, Landroid/support/v4/widget/h;
    ...
    :cond_1
    invoke-direct {p0, p2, v1}, Landroid/support/v4/widget/h$a;->a(Landroid/support/v4/view/a/c;Landroid/support/v4/view/a/c;)V

    invoke-virtual {v1}, Landroid/support/v4/view/a/c;->s()V

    check-cast p1, Landroid/view/ViewGroup;

    invoke-direct {p0, p2, p1}, Landroid/support/v4/widget/h$a;->a(Landroid/support/v4/view/a/c;Landroid/view/ViewGroup;)V
...
.method public a(Landroid/view/ViewGroup;Landroid/view/View;Landroid/view/accessibility/AccessibilityEvent;)Z
    ...
    invoke-static {p2}, Landroid/support/v4/widget/h;->l(Landroid/view/View;)Z
...
.method public b(Landroid/view/View;Landroid/view/accessibility/AccessibilityEvent;)Z
    ...
    iget-object v1, p0, Landroid/support/v4/widget/h$a;->b:Landroid/support/v4/widget/h;

    invoke-static {v1}, Landroid/support/v4/widget/h;->a(Landroid/support/v4/widget/h;)Landroid/view/View;

    move-result-object v1

    if-eqz v1, :cond_0

    iget-object v2, p0, Landroid/support/v4/widget/h$a;->b:Landroid/support/v4/widget/h;

    invoke-virtual {v2, v1}, Landroid/support/v4/widget/h;->e(Landroid/view/View;)I

    move-result v1

    iget-object v2, p0, Landroid/support/v4/widget/h$a;->b:Landroid/support/v4/widget/h;

    invoke-virtual {v2, v1}, Landroid/support/v4/widget/h;->b(I)Ljava/lang/CharSequence;
